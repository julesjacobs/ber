...
- Review the git diff after `./ber.sh` to spot behavioral changes or regressions in the fixtures. If you notice known issues, add comments like `(* CR codex: ... *)` in the `.ber` files.
